...
import net.Greek.Tenebris.block.entity.plushies.AsukaPlushBlockEntity;
...
public class AsukaPlushBlock extends BasePlushBlock {
    @Nullable //remember to override
    @Override
    public BlockEntity newBlockEntity(BlockPos pPos, BlockState pState) {
        return new AsukaPlushBlockEntity(pPos, pState);
    }
}*/
