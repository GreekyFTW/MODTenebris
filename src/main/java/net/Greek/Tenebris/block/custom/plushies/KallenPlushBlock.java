...
import net.Greek.Tenebris.block.entity.plushies.KallenPlushBlockEntity;
...
public class KallenPlushBlock extends BasePlushBlock {
    @Nullable //remember to override
    @Override
    public BlockEntity newBlockEntity(BlockPos pPos, BlockState pState) {
        return new KallenPlushBlockEntity(pPos, pState);
    }
}*/
